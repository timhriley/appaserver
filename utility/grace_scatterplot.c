...
*/
	...
	{
		fprintf( stderr,
"Usage: %s application session title subtitle xaxis_label yaxis_label [zaxis_label]\n",
			argv[ 0 ] );
...
"Note: the y axis is the dependent variable. x and z are independent.\n" );
		...
		fprintf( stderr,
"Note: zaxis_label is not implemented.\n" );
			...
			char *yaxis_label )
{
	...
	*subtitle = '\0';
	...
	first_grace_graph = list_get_first_pointer( grace->graph_list );
