...
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('income_statement','null','null','null','subclassification_option','3',null,null,null,null);
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('income_statement','null','null','prior_year_count','null','2',null,null,null,null);
delete from $javascript_processes where process = 'income_statement';
delete from $process_generic_output where process = 'income_statement';
