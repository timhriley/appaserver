...
echo "alter table $table_name add itemize_transactions_yn char (1);" | sql.e
...
echo "insert into $folder_attribute_table				\
	(folder,attribute,primary_key_index,display_order,		\
	 ...
	 lookup_required_yn )						\
	values								\
	('tax_form_line','itemize_transactions_yn',null,3,'n','n','n','n','n','n','n');" 	 |
sql.e
...
echo "insert into $attribute_table					\
	...
	values								\
	('itemize_transactions_yn','text',1,0,'','n','','','n','n');"		 |
sql.e
