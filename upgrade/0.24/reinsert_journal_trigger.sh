...
insert into process (process,command_line,notepad,html_help_file_anchor,execution_count,post_change_javascript,process_group,process_set_display,javascript_filename,preprompt_help_text) values ('post_change_journal_ledger','journal_trigger fund_name full_name contact_key transaction_date_time account debit_amount credit_amount \$state preupdate_fund_name preupdate_transaction_date_time preupdate_account preupdate_debit_amount preupdate_credit_amount',null,null,null,null,null,null,null,null);
