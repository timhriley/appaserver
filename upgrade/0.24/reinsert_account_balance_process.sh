...
insert into process (process,command_line,notepad,html_help_file_anchor,execution_count,post_change_javascript,process_group,process_set_display,javascript_filename,preprompt_help_text) values ('account_balance','account_balance_execute \$process fund_name as_of_date full_name contact_key investment_purpose execute_yn',null,null,null,null,'output',null,null,null);
