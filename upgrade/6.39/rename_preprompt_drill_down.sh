...
table_name=`get_table_name $application process_parameter`
...
echo "alter table $table_name change preprompt_yn drilldown_yn char (1);" | sql.e 2>&1 | grep -v 'Unknown column'
exit 0
