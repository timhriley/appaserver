...
insert into $process (process,command_line,notepad,html_help_file_anchor,post_change_javascript,appaserver_yn,process_group,process_set_display,preprompt_help_text) values ('close_nominal_accounts','close_nominal_accounts \$process as_of_date undo_yn execute_yn',null,null,'post_change_close_nominal_accounts( this )',null,'administer',null,null);
...
delete from $javascript_processes where process = 'close_nominal_accounts';
insert into $javascript_processes (javascript_filename,process) values ('post_change_close_nominal_accounts.js','close_nominal_accounts');
delete from $process_generic_output where process = 'close_nominal_accounts';
...
insert into $javascript_files (javascript_filename) values ('post_change_close_nominal_accounts.js');
all_done
