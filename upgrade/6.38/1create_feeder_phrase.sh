...
echo "create table $table_name (feeder_phrase char (255) not null,nominal_account char (60),full_name char (60),street_address char (60),feeder_phrase_ignore_yn char (1)) engine MyISAM;" | sql.e
