...
delete from $attribute where attribute = 'account_end_date';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('account_end_date','date','10',null,null,null,null,null,null,null);
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('feeder_load_event','account_end_date',null,'3',null,null,null,null,null,null,null);
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('feeder_load_event','feeder_account',1,null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('feeder_load_event','feeder_load_date',2,null,null,null,null,null,null,null,null);
...
echo "create table $table_name (feeder_load_date char (10) not null,feeder_account char (30) not null,login_name char (50),feeder_load_filename char (80),account_end_date char (10), account_end_balance double (12,2)) engine MyISAM;" | sql.e
echo "create unique index $table_name on $table_name (feeder_load_date,feeder_account);" | sql.e
