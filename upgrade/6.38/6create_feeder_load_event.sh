...
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('feeder_load_date_time','date_time','16',null,null,null,null,null,null,null);
...
echo "create table $table_name (feeder_account char (30) not null,feeder_load_date_time char (16) not null,login_name char (50),feeder_load_filename char (80),account_end_date char (10), account_end_balance double (12,2)) engine MyISAM;" | sql.e
echo "create unique index $table_name on $table_name (feeder_account,feeder_load_date_time);" | sql.e
