...
/* insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('feeder_row','journal_ledger','null',null,null,null,null,null,null,null,null,null,null,null); */

/* insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal_ledger','full_name','full_name',1); */
/* insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal_ledger','street_address','street_address',2); */
/* insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal_ledger','transaction_date_time','transaction_date_time',3); */
/* insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal_ledger','feeder_account','account',4); */
...
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('feeder_load_date_time','text','19',null,null,null,null,null,null,null);
...
insert into $role_folder (folder,role,permission) values ('feeder_row','supervisor','update');
