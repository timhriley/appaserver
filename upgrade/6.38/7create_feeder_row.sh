...
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('feeder_row','journal','null',null,null,null,null,null,null,null,null,null,null,null);
insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal','full_name','full_name',1);
insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal','street_address','street_address',2);
insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal','transaction_date_time','transaction_date_time',3);
insert into foreign_attribute (folder,related_folder,related_attribute,foreign_attribute,foreign_key_index) values ('feeder_row','journal','feeder_account','account',4);
...
delete from $attribute where attribute = 'feeder_description';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('feeder_description','text','140',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'feeder_amount';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('feeder_amount','float','12','2',null,null,null,null,null,null);
delete from $attribute where attribute = 'feeder_row_balance';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('feeder_row_balance','float','12','2',null,null,null,null,null,null);
...
delete from $attribute where attribute = 'feeder_load_date';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('feeder_load_date','date','10',null,null,null,null,null,null,null);
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('feeder_account','text','30',null,null,'y',null,null,null,null);
delete from $folder_attribute where folder = 'feeder_row';
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('feeder_row','feeder_account',null,1,null,null,'y',null,null,null,null);
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('feeder_row','file_row_description',null,4,null,null,'y',null,null,null,null);
...
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('feeder_row','full_name',null,1,null,null,null,null,null,null,null);
...
insert into $role_operation (folder,role,operation) values ('feeder_row','supervisor','delete');
