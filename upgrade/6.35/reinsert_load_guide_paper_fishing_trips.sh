...
insert into $process_parameter (process,folder,attribute,prompt,drop_down_prompt,display_order,drop_down_multi_select_yn,preprompt_yn,populate_drop_down_process,populate_helper_process) values ('load_guide_paper_fishing_trips','null','null','replace_existing_data_yn','null','2',null,null,null,null);
