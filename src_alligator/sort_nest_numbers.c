/* --------------------------------------------------	*/
/* $APPASERVER_HOME/src_alligator/sort_nest_numbers.c	*/
/* --------------------------------------------------	*/
/*							*/
			...
			char *input_number_string )
{
	...
	/* -------------------- */
	piece( list_left_half_string, '-', list_number_string, 0 );

	*list_right_half_string = '\0';
	piece( list_right_half_string, '-', list_number_string, 1 );
	...
	/* Parse input number */
	/* ------------------ */
	piece( input_left_half_string, '-', input_number_string, 0 );

	*input_right_half_string = '\0';
	piece( input_right_half_string, '-', input_number_string, 1 );
...
void sort_nest_numbers_output( LIST *list )
{
