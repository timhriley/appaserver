...
echo "create table $table_name (full_name char (60) not null,street_address char (40) not null,sale_date_time datetime not null,shipping_revenue double (8,2),sum_extension double (10,2),sales_tax double (7,2),invoice_amount double (10,2),total_payment double (10,2),amount_due double (10,2),completed_date_time datetime,uncollectible_writeoff_date date,transaction_date_time datetime) engine MyISAM;" | sql.e
...
insert into transaction ( full_name, street_address, transaction_date_time, transaction_amount, memo ) values ( 'changeme', '1234 Main St.', '2020-07-27 11:17:32', '$cash_opening_balance', 'Opening entry' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, debit_amount ) values ( 'changeme', '1234 Main St.', '2020-07-27 11:17:32', '$cash_account_name', '$cash_opening_balance' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, credit_amount ) values ( 'changeme', '1234 Main St.', '2020-07-27 11:17:32', '$equity_account_name', '$cash_opening_balance' );
...
insert into bank_upload_transaction ( bank_date, bank_description, full_name, street_address, transaction_date_time ) values ( '2020-07-27', 'Opening balance', 'changeme', '1234 Main St.', '2020-07-27 11:17:32' );
all_done13
) | sql.e 2>&1 | grep -vi duplicate
...
insert into inventory (inventory_name,inventory_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Mobil1 Oil Filter','inventory','cost_of_goods_sold','standard','16.99','20','0','0.0000','0.00000');
insert into inventory (inventory_name,inventory_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('Plain oil','inventory','cost_of_goods_sold','standard','10.00','50','0','0.0000','0.00000');
insert into inventory (inventory_name,inventory_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('PZL Platium SAE 5W20','inventory','cost_of_goods_sold','standard','10.00','100','0','0.0000','0.00000');
insert into inventory (inventory_name,inventory_account,cost_of_goods_sold_account,inventory_category,retail_price,reorder_quantity,quantity_on_hand,average_unit_cost,total_cost_balance) values ('PZL Platium SAE 5W30','inventory','cost_of_goods_sold','standard','10.00','100','0','0.0000','0.00000');
all_done8
) | sql.e 2>&1 | grep -vi duplicate
...
table=`get_table_name ignored relation`
echo "insert into $table (folder,related_folder,related_attribute) values ('customer_sale','customer','null');" | sql.e
exit 0
