...
/* Prototypes */
/* ---------- */
void post_change_hourly_service_work_delete(
...
void post_change_hourly_service_work_insert(
				char *application_name,
				char *full_name,
				char *street_address,
				char *sale_date_time,
...
void post_change_hourly_service_work_update(
				char *application_name,
				char *full_name,
				char *street_address,
				char *sale_date_time,
...
int main( int argc, char **argv )
{
	...
	{
		fprintf( stderr,
"Usage: %s ignored full_name street_address sale_date_time service_name description begin_work_date_time state preupdate_end_work_date_time\n",
			 argv[ 0 ] );
		exit ( 1 );
	}
	...
	state = argv[ 8 ];
	preupdate_end_work_date_time = argv[ 9 ];
