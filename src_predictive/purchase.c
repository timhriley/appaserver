			...
			char *purchase_date_time )
{
	...
	purchase_order = purchase_calloc();
	purchase_order->full_name = full_name;
	purchase_order->street_address = street_address;
...
{
	return fixed_asset_total( fixed_asset_list );
}
...
{
	return
"full_name,street_address,purchase_date_time,sales_tax,freight_in,arrived_date_time,purchase_price_total,purchase_amount,amount_due,transaction_date_time";
}
...
"full_name,street_address,purchase_date_time,sales_tax,freight_in,arrived_date_time,purchase_price_total,purchase_amount,amount_due,transaction_date_time";
	...
	purchase_order->purchase_price_total = atof( piece_buffer );

	piece( piece_buffer, SQL_DELIMITER, input, 7 );
	purchase_order->purchase_amount = atof( piece_buffer );
	...
	purchase_order->purchase_fixed_asset_list =
