...
insert into $folder (folder,form,insert_rows_number,subschema,populate_drop_down_process,notepad,lookup_before_drop_down_yn,no_initial_capital_yn,post_change_javascript,post_change_process,html_help_file_anchor,exclude_application_export_yn,lookup_email_output_yn,create_view_statement,appaserver_yn,data_directory,index_directory) values ('band_member','prompt','5','musician',null,null,null,null,null,null,null,null,null,null,null,null,null);
delete from $relation where folder = 'band_member';
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('band_member','musician','null',null,null,null,'y',null,null,null,null,null,null,null);
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('band_member','status','null',null,null,null,null,null,null,null,null,null,null,null);
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('section','band_member','null',null,null,null,null,null,null,null,null,null,null,'Section leader');
insert into $relation (folder,related_folder,related_attribute,pair_1tom_order,omit_1tom_detail_yn,prompt_mto1_recursive_yn,relation_type_isa_yn,copy_common_attributes_yn,omit_lookup_before_drop_down_yn,automatic_preselection_yn,ajax_fill_drop_down_yn,drop_down_multi_select_yn,join_1tom_each_row_yn,hint_message) values ('member_position','band_member','null',null,null,null,null,null,null,null,null,null,null,null);
...
delete from $attribute where attribute = 'status';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('status','text','10',null,null,null,null,null,null,null);
delete from $attribute where attribute = 'contact_information_private_yn';
insert into $attribute (attribute,attribute_datatype,width,float_decimal_places,post_change_javascript,hint_message,on_focus_javascript_function,lookup_histogram_output_yn,lookup_time_chart_output_yn,appaserver_yn) values ('contact_information_private_yn','text','1',null,null,null,null,null,null,null);
delete from $folder_attribute where folder = 'band_member';
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('band_member','contact_information_private_yn',null,'3',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('band_member','full_name','1',null,null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('band_member','status',null,'1',null,null,null,null,null,null,null);
insert into $folder_attribute (folder,attribute,primary_key_index,display_order,omit_insert_yn,omit_insert_prompt_yn,additional_unique_index_yn,additional_index_yn,omit_update_yn,lookup_required_yn,insert_required_yn) values ('band_member','street_address','2',null,null,null,null,null,null,null,null);
insert into $role_folder (folder,role,permission) values ('band_member','accountant','insert');
insert into $role_folder (folder,role,permission) values ('band_member','accountant','update');
insert into $role_folder (folder,role,permission) values ('band_member','supervisor','insert');
insert into $role_folder (folder,role,permission) values ('band_member','supervisor','update');
delete from $javascript_folders where folder = 'band_member';
insert into $role (role,folder_count_yn,override_row_restrictions_yn) values ('accountant','y',null);
insert into $role (role,folder_count_yn,override_row_restrictions_yn) values ('supervisor','y','y');
insert into $subschemas (subschema) values ('musician');
...
insert into $role_operation (folder,role,operation) values ('band_member','supervisor','delete');
...
insert into subclassification (subclassification,element,display_order) values ('goodwill','equity','19');
...
insert into role_operation (folder,role,operation) values ('composition','supervisor','detail');
insert into role_operation (folder,role,operation) values ('concert','supervisor','delete');
insert into role_operation (folder,role,operation) values ('concert','supervisor','detail');
insert into role_operation (folder,role,operation) values ('concert_program','supervisor','delete');
insert into role_operation (folder,role,operation) values ('concert_program','supervisor','detail');
insert into role_operation (folder,role,operation) values ('contact','supervisor','delete');
insert into role_operation (folder,role,operation) values ('contact','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('event_calendar','supervisor','delete');
insert into role_operation (folder,role,operation) values ('event_calendar','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('instrument','supervisor','delete');
insert into role_operation (folder,role,operation) values ('instrument','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('member_position','supervisor','delete');
insert into role_operation (folder,role,operation) values ('member_position','supervisor','detail');
insert into role_operation (folder,role,operation) values ('music_folder','supervisor','delete');
insert into role_operation (folder,role,operation) values ('music_folder','supervisor','detail');
insert into role_operation (folder,role,operation) values ('musician','accountant','delete');
insert into role_operation (folder,role,operation) values ('musician','accountant','delete_isa_only');
insert into role_operation (folder,role,operation) values ('musician','accountant','detail');
insert into role_operation (folder,role,operation) values ('musician','supervisor','delete');
insert into role_operation (folder,role,operation) values ('musician','supervisor','detail');
insert into role_operation (folder,role,operation) values ('opt_out','supervisor','delete');
insert into role_operation (folder,role,operation) values ('opt_out','supervisor','detail');
insert into role_operation (folder,role,operation) values ('patron','supervisor','delete');
insert into role_operation (folder,role,operation) values ('patron','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('position','supervisor','delete');
insert into role_operation (folder,role,operation) values ('position','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('rehearsal_lineup','supervisor','delete');
...
insert into role_operation (folder,role,operation) values ('secondary_instrument','supervisor','detail');
insert into role_operation (folder,role,operation) values ('section','supervisor','delete');
insert into role_operation (folder,role,operation) values ('section','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('status','supervisor','delete');
insert into role_operation (folder,role,operation) values ('status','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('substitute','supervisor','delete');
insert into role_operation (folder,role,operation) values ('substitute','supervisor','delete_isa_only');
insert into role_operation (folder,role,operation) values ('substitute','supervisor','detail');
...
insert into role_operation (folder,role,operation) values ('venue','supervisor','delete');
insert into role_operation (folder,role,operation) values ('venue','supervisor','detail');
insert into role_operation (folder,role,operation) values ('website_sidebar','supervisor','delete');
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('send_patron_mail','send_patron_mail.sh ignored email_address date time',null,null,null,null,'manipulate',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_concert','populate_concert.sh ignored',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('send_patron_calendar_message','send_patron_calendar_message.sh concert_title date \$process execute_yn',null,null,null,null,'manipulate',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('composition_venue_count','composition_venue_count_output ignored \$session \$process composition city venue output_medium',null,null,null,null,'output',null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_composition','populate_composition.sh ignored \$one2m_folder \$state',null,null,null,null,null,null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('populate_music_folder','populate_music_folder.sh ignored \$one2m_folder \$state',null,null,null,null,null,null,null);
...
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('load_cash_spreadsheet','load_bank_spreadsheet \$process \$login_name fund bank_of_america_checking filename 1 2 3 -1 4 transactions_only_yn reverse_order_yn execute_yn',null,null,null,null,'reconcile',null,null);
insert into process (process,		command_line,		notepad,		html_help_file_anchor,		post_change_javascript,		process_set_display,		process_group,		preprompt_help_text,		appaserver_yn) values ('load_credit_spreadsheet','load_bank_spreadsheet \$process \$login_name fund bank_of_america_credit_card filename 1 3 5 -1 -1 transactions_only_yn reverse_order_yn execute_yn',null,null,null,null,'reconcile',null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('composition_venue_count','null','null','composition_venue_output_medium','null','3',null,null,null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('composition_venue_count','composition','null','null','null','1',null,null,null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('send_patron_calendar_message','concert','null','null','null','2',null,null,null,null);
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('send_patron_calendar_message','null','null','null','execute_yn','2',null,null,null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('composition_venue_count','venue','null','null','null','2',null,null,null,null);
...
insert into process_parameter (process,		folder,		attribute,		drop_down_prompt,		prompt,		display_order,		drop_down_multi_select_yn,		preprompt_yn,		populate_drop_down_process,		populate_helper_process) values ('insert_program_from_rehearsal_lineup','concert','null','null','null','1',null,null,null,null);
...
insert into role_process (process,role) values ('composition_venue_count','supervisor');
...
insert into role_process (process,role) values ('insert_program_from_rehearsal_lineup','supervisor');
...
insert into drop_down_prompt (drop_down_prompt,hint_message,optional_display) values ('composition_venue_output_medium',null,'output_medium');
...
insert into drop_down_prompt_data (drop_down_prompt,drop_down_prompt_data,display_order) values ('composition_venue_output_medium','spreadsheet','2');
insert into drop_down_prompt_data (drop_down_prompt,drop_down_prompt_data,display_order) values ('composition_venue_output_medium','table','1');
...
insert into operation (operation,output_yn) values ('send_patron_mail','n');
...
insert into transaction ( full_name, street_address, transaction_date_time, transaction_amount, memo ) values ( 'changeme', '1234 Main St.', '2020-07-27 11:17:14', '$cash_opening_balance', 'Opening entry' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, debit_amount ) values ( 'changeme', '1234 Main St.', '2020-07-27 11:17:14', '$cash_account_name', '$cash_opening_balance' );
insert into journal_ledger ( full_name, street_address, transaction_date_time, account, credit_amount ) values ( 'changeme', '1234 Main St.', '2020-07-27 11:17:14', '$equity_account_name', '$cash_opening_balance' );
...
insert into bank_upload_transaction ( bank_date, bank_description, full_name, street_address, transaction_date_time ) values ( '2020-07-27', 'Opening balance', 'changeme', '1234 Main St.', '2020-07-27 11:17:14' );
all_done13
) | sql.e 2>&1 | grep -vi duplicate
