...
void google_barchart_set_point(
			LIST *barchart_list,
			char *stratum_name,
			LIST *datatype_name_list,
			char *datatype_name,
...
void google_timeline_set_point(
			LIST *timeline_list,
			LIST *datatype_name_list,
			char *date_string,
			char *time_hhmm,
...
void google_barchart_set_point_string(
			LIST *barchart_list,
			LIST *datatype_name_list,
			char *delimited_string,
			char delimiter );

void google_timeline_set_point_string(
			LIST *timeline_list,
			LIST *datatype_name_list,
			char *delimited_string,
			char delimiter );
...
void google_timeline_display(
			LIST *timeline_list,
			LIST *datatype_name_list );

void google_barchart_display(
			LIST *barchar_list,
			LIST *datatype_name_list );

void google_chart_include(
			FILE *output_file );
...
void google_chart_anchor_chart(
			FILE *output_file,
			char *title,
			char *google_package_name,
			int left,
...
char *google_chart_convert_date(
			char *destination,
			char *yyyy_mm_dd,
			char *hhmm );
...
GOOGLE_HAXIS *google_haxis_new(
			void );

GOOGLE_VAXIS *google_vaxis_new(
			void );

GOOGLE_DATA *google_data_new(
			void );
