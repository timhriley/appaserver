...
LIST *query_attribute_statistics_list_get_primary_list(
					LIST *attribute_list );

LIST *query_attribute_statistics_list_get_list(
					LIST *attribute_list );

char *query_get_query_attribute_statistics_sys_string(
					char *application_name,
					char *folder_name,
