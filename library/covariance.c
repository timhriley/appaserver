					...
					double value )
{
	...
	c = (COVARIANCE_RECORD *)calloc( 1, sizeof( COVARIANCE_RECORD ) );
...
COVARIANCE *covariance_new_covariance( char *anchor_datatype_group_name )
{
	...
	c = (COVARIANCE *)calloc( 1, sizeof( COVARIANCE ) );
						...
						char *datatype_name )
{
	...
	c = (COVARIANCE_DATATYPE *)calloc( 1, sizeof( COVARIANCE_DATATYPE ) );
					...
					char *datatype_name )
{
	...
	list_append_pointer(	compare_covariance_datatype_list,
				covariance_datatype );
				...
				LIST *date_time_key_list )
{
	...
	*standard_deviation = 0.0;
	...
	do {
		results_string = list_get_pointer( results_list );
		...
		LIST *anchor_date_time_key_list )
{
	...
	do {
		date_time_key = list_get_pointer( anchor_date_time_key_list );
